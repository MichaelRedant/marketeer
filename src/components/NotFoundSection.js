...
import "../notfoundsection.css"; // Voeg hier de CSS toe

const NotFoundSection = () => {
    const [imgDataURI, setImgDataURI] = useState("");
  
    useEffect(() => {
      // Zet de Data URI in de state
      setImgDataURI(
  ...
  return (
    ...
    <div>
        <h2 className="pt-3">0 resultaten gevonden</h2>
        <h2 className="pt-3">404</h2>
        <p>Nog niet beschikbaar, kom later terug!</p>
      </div>
    </div>
  );
};
